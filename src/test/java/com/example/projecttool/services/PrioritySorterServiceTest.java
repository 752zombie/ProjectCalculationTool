...
class PrioritySorterServiceTest {
    ...
    void prioritySorter() {
        ...
        Task task = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06", "low", (byte) 1,true);
        Task task1 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","medium", (byte) 1, false);
        Task task2 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","high", (byte) 1, true);
        Task task3 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06","high", (byte) 1, true);
        Task task4 = new Task(1, "Test", "Test1", "2014-05-05", "2014-06-06", "high", (byte) 1, false);
        taskList.add(task);
        taskList.add(task1);
        taskList.add(task2);
        taskList.add(task3);
